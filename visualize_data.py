...
# Curcuminoid density measurement (mg/g) establishing the 2018 baseline leap
curcuminoid_density = np.array([42.1, 88.4, 87.9, 87.2, 86.5, 85.9, 85.1, 84.4, 83.8, 83.1])
# Percent retention under the 9-year metabolic stasis protocol
...
# Shaded span focusing on the milestone transformation year
ax1.axvspan(2017.8, 2018.2, color='#FFD700', alpha=0.18, label='2018 Potency Breakthrough')

# Callout text annotation pointing directly to the milestone value
ax1.annotate(
...
# --- 5. Labels, Aesthetics, & Scannability ---
...
# Consolidating legends from both axes securely
lines = line1 + line2
